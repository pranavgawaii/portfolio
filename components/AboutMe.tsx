...
const AboutMe = () => {
    ...
    return (
        <section id="about-me" className="max-w-3xl mx-auto px-4 mt-24 mb-20 scroll-mt-28">
            ...
            <div className="relative bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-start overflow-hidden">
                <BorderTrail
                    className="bg-gradient-to-l from-purple-200 via-purple-500 to-purple-200 dark:from-purple-400 dark:via-purple-500 dark:to-purple-400"
                    size={120}
                />
                {/* Image Section */}
