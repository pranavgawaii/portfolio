    ...
    <section className="w-full mb-0 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
      ...
      <div className="flex flex-col gap-4 mb-6 px-1">
        <div className="flex justify-between items-end">
          ...
          <div className="flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-full relative">
            <button
              onClick={() => setActiveTab('github')}
              className={cn(
                "relative z-10 p-2 text-sm font-bold rounded-full transition-all duration-300",
                activeTab === 'github'
            ...
            >
              ...
              {activeTab === 'github' && (
                <motion.div
                  layoutId="activeTab"
                  className="absolute inset-0 bg-white dark:bg-neutral-700 rounded-full shadow-sm -z-10"
